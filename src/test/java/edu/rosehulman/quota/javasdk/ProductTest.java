...
@PrepareForTest({ QuotaClient.class, Partner.class, User.class })
public class ProductTest {
  ...
  public void addUserTest() throws Exception {
    ...
    when(quotaClient.addUser(partner, product, user)).thenReturn(true);

    // Assert
    assertEquals(true, product.addUser(user));
  }
}
